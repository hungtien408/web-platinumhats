<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true"
    CodeFile="search-result.aspx.cs" Inherits="product" %>
            ...
            <div class="head head-lineb">
                ...
                <div class="head-title">
                    ...
                    <div class='<%= ((DataView)odsProduct.Select()).Count == 0 ? "node" : "node hide" %>'>
                        Sorry ! We could not find product with the keyword “ 
                        <asp:Label ID="lblTitle" runat="server"></asp:Label>”</div>
                </div>
            </div>
            <div class='<%= ((DataView)odsProduct.Select()).Count == 0 ? "product-none text-center" : "product-none text-center hide" %>'>
                <img class="searc-none" src="assets/images/search-none.jpg" alt="" />
            </div>
