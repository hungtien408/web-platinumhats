<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="materialcategory.aspx.cs" Inherits="ad_single_productcategory" %>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                ...
                                <img id="Img1" alt="" src='<%# "~/res/productcategory/" + Eval("ImageName") %>' width="80" runat="server"
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 270px x 213px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">
