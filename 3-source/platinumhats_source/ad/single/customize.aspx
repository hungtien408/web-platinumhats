<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="customize.aspx.cs" Inherits="ad_single_article" %>
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnIconName" runat="server" Value='<%# Eval("IconName") %>' />
                        </ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IconName" HeaderText="Icon" SortExpression="IconName" Visible="False">
                        <ItemTemplate>
                            <asp:Panel ID="Panel2" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("IconName").ToString()) ? false : true %>'>
                                <img id="Img1" alt="" src='<%# "~/res/article/icon/" + Eval("IconName") %>' width="80" runat="server"
                                    visible='<%# string.IsNullOrEmpty(Eval("IconName").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteIcon" runat="server" rel='<%#  Eval("ArticleID") + "#" + Eval("IconName") %>'
                                    CommandName="DeleteIcon" OnClientClick="return confirm('Xóa ảnh này ?')">
                                <img alt="Xóa ảnh" title="Xóa ảnh" src="../assets/images/delete-icon.png" />
                                </asp:LinkButton>
                            </asp:Panel>
                        </ItemTemplate>
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <asp:HiddenField ID="hdnOldIconName" runat="server" Value='<%# Eval("IconName") %>' />
                            <div class="edit">
                            ...
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 485px x 288px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left" valign="top">
                                    ...
                                    <td runat="server">
                                        <asp:RadUpload ID="FileIconName" runat="server" ControlObjectsVisibility="None"
                                            Culture="vi-VN" Language="vi-VN" InputSize="69" AllowedFileExtensions=".jpg,.jpeg,.gif,.png" />
                                        <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Sai định dạng ảnh (*.jpg, *.jpeg, *.gif, *.png)"
                                            ClientValidationFunction="validateRadUpload" Display="Dynamic"></asp:CustomValidator>
                                        <span class="required">(Kích thước 60px x 60px)</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadEditor ID="txtTitle2" StripFormattingOptions="MSWordRemoveAll,ConvertWordLists,MSWordNoFonts,Font,Css,Span" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP" runat="server" Height="200" Language="vi-VN" Skin="Office2007"
                                            Width="98%" Content='<%# Bind("Title2") %>'>
                                            <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/" MaxUploadFileSize="1024000" />
                                            <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                            <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/" MaxUploadFileSize="1024000" />
                                            <MediaManager DeletePaths="~/Uploads/Media/" UploadPaths="~/Uploads/Media/" ViewPaths="~/Uploads/Media/" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ArticleSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="9" Name="ArticleCategoryID" PropertyName="SelectedValue"
                Type="String" />
