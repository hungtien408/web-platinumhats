<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="custom-program.aspx.cs" Inherits="custom_program" %>
        ...
        <div class="container">
            <div class="head head-lineb mb35">
                        <div id="site" class="text-right">
                            <a class="home" id="A1" href="~/" runat="server">Home</a>&gt;<a href="news.aspx">Custom Program</a>&gt;<span>The Process</span>
                        </div>
                <div class="head-title">
                        <h4 class="text-uppercase title-1 font400 cotit">Custom oder process</h4>
                        <div class="node">4 easy steps to custom headwear</div>
                </div>
            </div>
            <h4 class="title-2 linebc text-center font300 cocus">How to place a custom order? (applies to caps, beanies and bucket hats)</h4>
            <div class="nodec text-center mb50">Placing a custom order of headwear with Platinum Hats Headwear is easy.</div>
